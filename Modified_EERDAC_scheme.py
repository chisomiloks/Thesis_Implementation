...
class EERDAC(object):
    ...
    def UserReg(self, GPP, entity='user'):
        """
        Registration of users carried out by the CA to generate their corresponding key pairs (i.e Public and Private Keys)
...
def wrapper(func, *args, **kwargs):
    """
    Wrapper function to enable the use of timeit for function which takes arguments

    :param func: function which is to be time
    :param args: arguments for the function
    :return: return the wrapped function within which runs the function that was given with its arguments
    """
