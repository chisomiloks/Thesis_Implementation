...
# # time master lists
# # key: authority name + number of trials: time results (list)
# encryption_time_master_my_scheme = {}
# decryption_time_master_my_scheme = {}
...
for number_of_authorities in number_of_attribute_authorities:
    ...
    # revocation tests
    revocation_time_my_scheme_temp = omacpabe.revocation_test(number_of_trials, number_of_authorities, number_of_authorities * 10)
    revocation_time_kan_yang_temp = kan_yang.revokedTest(number_of_trials, number_of_authorities, number_of_authorities * 10)

    # encryption_time_data_my_scheme[number_of_authorities] = encryption_time_my_scheme_temp
    # decryption_time_data_my_scheme[number_of_authorities] = decryption_time_my_scheme_temp
    # revocation_time_data_my_scheme[number_of_authorities] = revocation_time_my_scheme_temp
    # encryption_time_data_kan_yang_scheme[number_of_authorities] = encryption_time_kan_yang_temp
    # decryption_time_data_kan_yang_scheme[number_of_authorities] = decryption_time_kan_yang_temp
    # revocation_time_data_kan_yang_scheme[number_of_authorities] = revocation_time_kan_yang_temp
...
# wt.write_to_file(encryption_time_master_my_scheme, "Encryption time for my scheme")

end_time = dt.datetime.now()
print("End time is", end_time)

# print(encryption_time_data_my_scheme)
# print(encryption_time_data_kan_yang_scheme)
...
# print(encryption_time_data)
# print(decryption_time_data)

# write the corresponding data to a npy file for plotting
# np.save("encryption_time_data_" + str(number_of_trials) + "_trials", encryption_time_data)
# np.save("decryption_time_data_" + str(number_of_trials) + "_trials", decryption_time_data)
# np.save("revocation_time_data_" + str(number_of_trials) + "_trials", revocation_time_data)
wt.write_to_npy_file(encryption_time_data, "encryption_time_data_" + str(number_of_trials) + "_trials_" + dt.datetime.now().strftime("%d-%m-%y_%H:%M:%S"))
wt.write_to_npy_file(decryption_time_data, "decryption_time_data_" + str(number_of_trials) + "_trials_" + dt.datetime.now().strftime("%d-%m-%y_%H:%M:%S"))
wt.write_to_npy_file(revocation_time_data, "revocation_time_data_" + str(number_of_trials) + "_trials_" + dt.datetime.now().strftime("%d-%m-%y_%H:%M:%S"))
