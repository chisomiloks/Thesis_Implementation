...
wt.write_to_npy_file(encryption_time_data, "encryption_time_data_" + str(number_of_trials) + "_trials")
wt.write_to_npy_file(decryption_time_data, "decryption_time_data_" + str(number_of_trials) + "_trials")
wt.write_to_npy_file(revocation_time_data, "revocation_time_data_" + str(number_of_trials) + "_trials")
